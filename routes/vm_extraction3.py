...
tag = Tag(name='VirtualMachine', description="Read virtualmachiness from Turbo, extract data and download them")
vm_extraction = APIBlueprint('vm_extraction', __name__, abp_tags=[tag], url_prefix='/virtualmachines')
